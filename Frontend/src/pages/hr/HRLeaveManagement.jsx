...
import { useLeavesQuery, useUpdateLeaveStatus } from '../../hooks/api/useLeaveQueries';
                        ...
                        <Card key={leave.id} className="rounded-none border-foreground/10 shadow-none hover:border-foreground/30 transition-all p-8 flex flex-col h-full bg-background group relative overflow-hidden">
                            ...
                            <div className="flex items-start justify-between mb-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-black text-sm uppercase tracking-tighter leading-none">{leave.user_name}</p>
                                        <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mt-1.5">ID: {leave.emp_id}</p>
                                    </div>
                                </div>
                                <div className={cn(
