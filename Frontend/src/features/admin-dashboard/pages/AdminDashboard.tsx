        ...
        <DashboardLayout navItems={navItems} userRole="Global Administrator" userName="System Root" userInitials="SR">
            <div className="space-y-10 text-left">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" size="sm" className="font-medium text-sm h-9 border-border">
                            Maintenance
                        </Button>
                        <Button variant="default" size="sm" className="font-medium text-sm h-9 shadow-sm shadow-indigo-500/10">
                            Global Config
                        </Button>
                    </div>
                </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="pl-8 pr-3 py-1.5 bg-bg border border-soft rounded-lg text-sm outline-none w-28 focus:w-40 transition-all font-medium text-main placeholder:[var(--text-dim)]"
                                    />
                                </div>
