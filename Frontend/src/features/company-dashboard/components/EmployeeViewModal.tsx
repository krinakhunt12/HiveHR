...
const InfoRow = ({ icon, label, value, mono }: InfoRowProps) => (
    <div className="flex items-start gap-4 py-3.5 border-b border-border/40 last:border-0">
        ...
        <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-textSecondary mb-0.5">{label}</p>
            <p className={cn(
                'text-sm font-medium text-textPrimary truncate',
    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} title="Employee Profile" className="max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-2">
                ...
                <div>
                    <p className="text-xs font-semibold text-textSecondary mb-3 flex items-center gap-2">
