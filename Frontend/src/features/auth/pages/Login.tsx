          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1.5 flex flex-col items-start w-full">
              <div className="flex justify-between items-center ml-0.5 w-full">
                ...
                <Link to="#" className="text-sm font-semibold text-primary hover:opacity-70 transition-opacity">Forgot?</Link>
              </div>
              <div className="relative group w-full">
            ...
            <div className="space-y-1.5 flex flex-col items-start w-full">
              <label className="text-sm font-semibold text-muted ml-0.5">Login as</label>
              <select
                value={role}
