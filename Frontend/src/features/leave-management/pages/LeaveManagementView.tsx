            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="card-premium p-6 bg-white border-none shadow-premium">
                        <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Quota Allocation</h4>
                    ...
                    <div className="card-premium p-6 bg-gradient-to-br from-emerald-600 to-emerald-800 text-white border-none shadow-xl shadow-emerald-900/10">
                        <p className="text-[10px] font-bold uppercase tracking-widest text-emerald-200 mb-2">Protocol Note</p>
                        <p className="text-xs font-medium leading-relaxed">Ensure all maintenance requests are submitted 48 hours prior to commencement for optimal network stability.</p>
                    </div>
                </div>
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-slate-50/50">
                                <tr>
                                    ...
                                    <th className="px-8 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Type & Duration</th>
                                    <th className="px-8 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Status</th>
                                    {isAdmin && <th className="px-8 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">Action</th>}
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-50">
                                {isLoading ? (
                                    ...
                                    <tr key={leave.id} className="group hover:bg-emerald-50/30 transition-all">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase">{leave.profiles?.employee_code || 'ID-REDACTED'}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-5">
                                        ...
                                        <td className="px-8 py-5">
                                            <span className={cn(
                                                "px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest border inline-flex items-center gap-2",
    ...
    return (
        <div className="space-y-2">
            <div className="flex justify-between items-end">
                ...
                <span className="text-xs font-bold text-slate-700">{used} / {total} <span className="text-slate-300 text-[10px] font-medium">Days</span></span>
            </div>
