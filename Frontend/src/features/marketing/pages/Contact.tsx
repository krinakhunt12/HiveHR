                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                  <form className="space-y-4">
                    <div>
                      ...
                      <Input type="text" placeholder="Sarah Jenkins" className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 placeholder:text-indigo-300/50 focus:outline-none focus:ring-2 focus:ring-white/30 h-auto" />
                    </div>
                    <div>
                      <label className="text-sm font-bold  text-indigo-200 mb-2 block">Company Email</label>
                      <Input type="email" placeholder="name@company.com" className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 placeholder:text-indigo-300/50 focus:outline-none focus:ring-2 focus:ring-white/30 h-auto" />
                    </div>
                    <div>
                      <label className="text-sm font-bold  text-indigo-200 mb-2 block">Message</label>
                      <Textarea rows={4} placeholder="How can we help?" className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 placeholder:text-indigo-300/50 focus:outline-none focus:ring-2 focus:ring-white/30 resize-none h-auto" />
                    </div>
