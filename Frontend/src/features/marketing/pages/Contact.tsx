                ...
                <div className="lg:w-1/2 w-full max-w-md">
                   <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                     <form className="space-y-4">
                       <div>
                         <label className="text-xs font-bold uppercase tracking-widest text-indigo-200 mb-2 block">Full Name</label>
                       ...
                       <div>
                         <label className="text-xs font-bold uppercase tracking-widest text-indigo-200 mb-2 block">Message</label>
